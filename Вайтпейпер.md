<!-- Копия первоисточника. Ведётся в репозитории EduStableCoin;
     сюда положена, чтобы вики читалась целиком, не уходя наружу. -->

> Это полный текст вайтпейпера EduStableCoin. Ведётся он в
> [репозитории концепта](https://github.com/megumi-joy/EduStableCoin/blob/main/WHITEPAPER.md) —
> если тексты разойдутся, верен тот.
